...
function popupOnload() {
    ...
    document.getElementById("version_text").innerHTML = "<span class='history_date_text'>Eklenti Sürümü</span><br>" + chrome.runtime.getManifest().version;
}
...
document.getElementById("btn_settings_off").addEventListener("click", function() {
    ...
    document.getElementById("btn_hide_history").click();
...
document.getElementById("btn_show_details").addEventListener("click", function() {
    ...
    document.getElementById("details_scroll").scrollIntoView();
});
...
document.getElementById("btn_show_history").addEventListener("click", function() {
    document.getElementById("btn_show_history").style.display = "none";
    document.getElementById("btn_hide_history").style.display = "block";
    document.getElementById("history_content").style.display = "block";
    document.getElementById("history_scroll").scrollIntoView();
    if(historyContent.length > 0) {document.getElementById("btn_clear_history").style.display = "block";}
});
document.getElementById("btn_hide_history").addEventListener("click", function() {
    document.getElementById("btn_show_history").style.display = "block";
    document.getElementById("btn_hide_history").style.display = "none";
    document.getElementById("btn_clear_history").style.display = "none";
...
document.getElementById("btn_clear_history").addEventListener("click", function() {
    document.getElementById("history_content").innerHTML = "<i style='font-size: 120px;margin-bottom: 5px;' class='fas fa-trash'></i><br>Geçmiş Boş";
    document.getElementById("btn_clear_history").style.display = "none";
    historyContent = "";
    setStorage();
    loadStorage();
