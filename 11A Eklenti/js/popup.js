...
document.getElementById("btn_dolar").addEventListener("click", function() {
    if(input_currency.value.length > 0) {
        go("https://www.google.com/search?q=" + input_currency.value + "+dolar+kaç+TL&ie=UTF-8");
    } else{go("https://www.google.com/search?q=dolar%2FTL&ie=UTF-8");}
});

document.getElementById("btn_euro").addEventListener("click", function() {
    if(input_currency.value.length > 0) {
        go("https://www.google.com/search?q=" + input_currency.value + "+euro+kaç+TL&ie=UTF-8");
    } else{go("https://www.google.com/search?q=euro%2FTL&ie=UTF-8");}
});  

document.getElementById("btn_pound").addEventListener("click", function() {
    if(input_currency.value.length > 0) {
        go("https://www.google.com/search?q=" + input_currency.value + "+sterlin+kaç+TL&ie=UTF-8");
    } else{go("https://www.google.com/search?q=sterlin%2FTL&ie=UTF-8");}
});
...
document.getElementById("btn_timer").addEventListener("click", function() {
    go("http://timer.onlinealarmkur.com/" + "#" + input_timer_numpad.value);
});
